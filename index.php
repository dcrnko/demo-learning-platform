...
<html lang="en">
    <head>
        ...
        <title>Study with Dave Demo</title>
        ...
        <section class="slider_area row m0">
            <div class="slider_inner">
                <div class="camera_caption">
                    <h2 class="wow fadeInUp animated">Study With Dave</h2>
        ...
        <footer class="footer_area row">
            <div class="container custom-container">
                ...
                <div class="copy_right_area">
                    <h4 class="copy_right">© Copyright 2025 Dave Ecommerce | All Rights Reserved</h4>
                </div>
            </div>
        </footer>
